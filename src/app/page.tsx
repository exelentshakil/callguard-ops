...
import { CallSessionInspector } from '@/components/CallSessionInspector';
import { VoiceAgentTuningBench } from '@/components/VoiceAgentTuningBench';
import { MakeScenarioWorkbench } from '@/components/MakeScenarioWorkbench';
import { WappiGatewayMonitor } from '@/components/WappiGatewayMonitor';
    ...
    <div className="min-h-screen bg-[var(--color-canvas)] text-[var(--color-text-primary)]">
      ...
      <main className="w-full max-w-full min-w-0 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 space-y-8">
          ...
          <section id="calls" className="scroll-mt-20">
            <CallSessionInspector />
          </section>

          <section id="voice-tuning" className="scroll-mt-20">
            <VoiceAgentTuningBench />
          </section>

          <section id="make-scenarios" className="scroll-mt-20">
            <MakeScenarioWorkbench />
          </section>

          <section id="wappi-gateway" className="scroll-mt-20">
            <WappiGatewayMonitor />
          </section>
